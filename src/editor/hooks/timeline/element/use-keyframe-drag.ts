...
import { snapTimeToFrame, getSnappedSeekTime } from "@/editor/lib/time";
import { timelineTimeToSnappedPixels } from "@/editor/lib/timeline";
import {
	DRAG_THRESHOLD_PX,
	TIMELINE_CONSTANTS,
} from "@/editor/constants/timeline-constants";
import { RetimeKeyframeCommand } from "@/editor/lib/commands/timeline/element/keyframes/retime-keyframe";
import { BatchCommand } from "@/editor/lib/commands";
import type { SelectedKeyframeRef } from "@/editor/types/animation";
import type { TimelineElement } from "@/editor/types/timeline";
import type { Command } from "@/editor/lib/commands/base-command";
