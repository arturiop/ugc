...
import { useShiftKey } from "@/editor/hooks/use-shift-key";
import type { TextElement, Transform } from "@/editor/types/timeline";
import { getVisibleElementsWithBounds } from "@/editor/lib/preview/element-bounds";
import { hitTest } from "@/editor/lib/preview/hit-test";
import {
	screenPixelsToLogicalThreshold,
	screenToCanvas,
} from "@/editor/lib/preview/preview-coords";
import { isVisualElement } from "@/editor/lib/timeline/element-utils";
import {
	SNAP_THRESHOLD_SCREEN_PIXELS,
	snapPosition,
	type SnapLine,
} from "@/editor/lib/preview/preview-snap";
