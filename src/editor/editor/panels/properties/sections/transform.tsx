...
import { clamp, isNearlyEqual } from "@/editor/utils/math";
import type { AnimationPropertyPath } from "@/editor/types/animation";
import type { VisualElement } from "@/editor/types/timeline";
import {
	Section,
	SectionContent,
	SectionField,
...
import { DEFAULT_TRANSFORM } from "@/editor/constants/timeline-constants";
import { TIME_EPSILON_SECONDS } from "@/editor/constants/animation-constants";
import { getElementLocalTime, resolveTransformAtTime } from "@/editor/lib/animation";
