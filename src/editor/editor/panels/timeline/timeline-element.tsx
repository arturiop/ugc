...
import { useTimelineElementResize } from "@/editor/hooks/timeline/element/use-element-resize";
import {
	useKeyframeDrag,
	type KeyframeDragState,
} from "@/editor/hooks/timeline/element/use-keyframe-drag";
import { useKeyframeSelection } from "@/editor/hooks/timeline/element/use-keyframe-selection";
import type { SnapPoint } from "@/editor/lib/timeline/snap-utils";
import { getElementKeyframes } from "@/editor/lib/animation";
import {
	getTrackClasses,
	getTrackHeight,
	canElementHaveAudio,
...
import { getActionDefinition, type TAction, invokeAction } from "@/editor/lib/actions";
...
import { uppercase } from "@/editor/utils/string";
import type { ComponentProps, ReactNode } from "react";
import type { SelectedKeyframeRef, ElementKeyframe } from "@/editor/types/animation";
import { cn } from "@/editor/utils/ui";
import { Button } from "@/editor/ui/button";
import { usePropertiesStore } from "@/editor/stores/properties-store";
